...
namespace Saldoa.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260920203126_AddWorkspaceToFinancialEntities")]
    partial class AddWorkspaceToFinancialEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Saldoa.Domain.Entities.CategoryBudget", b =>
                {
                    ...
                    b.HasIndex("WorkspaceId", "CategoryId", "PeriodStart", "PeriodEnd")
                        .IsUnique();
            ...
            modelBuilder.Entity("Saldoa.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.HasIndex("WorkspaceId", "PaidOrReceivedAt");

                    b.ToTable("transactions", "app");
                });

            modelBuilder.Entity("Saldoa.Domain.Entities.Workspace", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("workspace", "app");
                });

            modelBuilder.Entity("Saldoa.Domain.Entities.WorkspaceInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("workspace_invitation", "app");
                });

            modelBuilder.Entity("Saldoa.Domain.Entities.WorkspaceMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("workspace_memberships", "app");
                });

            modelBuilder.Entity("Saldoa.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Saldoa.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Saldoa.Domain.Entities.Category", b =>
                {
                    b.HasOne("Saldoa.Domain.Entities.Workspace", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Saldoa.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.OwnsOne("Saldoa.Domain.ValueObjects.InstallmentInfo", "InstallmentInfo", b1 =>
                        {
                            b1.Property<long>("TransactionId")
                                .HasColumnType("bigint");

                            b1.Property<Guid?>("InstallmentGroupId")
                                .HasColumnType("uuid")
                            ...
                            b1.HasIndex("InstallmentGroupId")
                                .HasFilter("installment_group_id IS NOT NULL");

                            b1.ToTable("transactions", "app");
            ...
            modelBuilder.Entity("Saldoa.Domain.Entities.WorkspaceMembership", b =>
                {
                    ...
                    b.HasOne("Saldoa.Domain.Entities.Workspace", "Workspace")
