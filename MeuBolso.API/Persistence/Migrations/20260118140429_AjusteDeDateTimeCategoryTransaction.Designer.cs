...
namespace MeuBolso.API.Persistence.Migrations
{
    ...
    [Migration("20260118140429_AjusteDeDateTimeCategoryTransaction")]
    partial class AjusteDeDateTimeCategoryTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeuBolso.Domain.Auth.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MeuBolso.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("PaidOrReceivedAt")
                        .HasColumnType("timestamp with time zone")
